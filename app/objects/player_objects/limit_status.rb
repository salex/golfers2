=begin
  Limits is an extension to Groups and stored in Group.settings

  Limiting defines several status that will limit the number of PlusMinus points will be used
  to in scoring a team (or individual team). Groups are usually unsure that a new players declared 
  ...
  The status is stored the the game.round when created but is also used  anywhere a 
  quota is displayed
